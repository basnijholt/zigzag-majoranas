...
In App.~\ref{appendix:mfp_vs_gap} we compare the size of $E_\textrm{gap}$ as a function of the mean free path $l_e$ for zigzag and straight systems at $\phi=0$ and $\phi=\pi$; and confirm that the zigzag geometry and disorder both increase $E_\textrm{gap}$ through a similar mechanism.
...
The right amount of disorder improves the Majorana properties~\onlinecite{Haim2019} and scatters long trajectories in a similar fashion to the zigzag geometry cutting off long trajectories.
...
At $\phi=\pi$ we observe that zigzag outperforms disorder.
