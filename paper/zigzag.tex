...
\caption{
System where the direction of the magnetic field is parallel to the NS interface.
...
\caption{
Comparison of the zigzag device's band structures with the magnetic field parallel to the NS interface [(a), (orange)] and a magnetic field in the $x$-direction (blue) for different values of $z_y$.
...
We have observed that $E_\textrm{gap}$ becomes $\SI{6.1}{\mu \eV}$, a two-fold increase compared to the straight system.
