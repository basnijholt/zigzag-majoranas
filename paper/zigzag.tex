...
Additionally, we simulated a device where the magnetic field is parallel to the NS interface and compare it with a field purely in the $x$-direction, the results are in Fig.~\ref{fig:snaking_magnetic_field}.
From these results we observe that gap enhancement effect persists.
