...
\begin{align}
    q &= \sqrt{\frac{2 m_\ast}{\hbar ^2}\left(\mu_s + E\right) - k_x^2}\\
    k_1 &= \sqrt{\frac{2 m_\ast}{\hbar^2} \left(\mu_n+ E-\sqrt{\text{Ez}^2-2 \alpha  \text{Ez} \sin (\theta ) k_x+\alpha ^2 k_x^2}\right) - k_x^2 }\\
    k_2 &= \sqrt{\frac{2 m_\ast}{\hbar^2} \left(\mu_n+ E+\sqrt{\text{Ez}^2-2 \alpha  \text{Ez} \sin (\theta ) k_x+\alpha ^2 k_x^2}\right) - k_x^2 }
\end{align}
