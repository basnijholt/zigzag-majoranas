...
It has been shown that interface disorder, pairbreaking, tunnel barrier to normal leads, temperature, and having multiple modes with different transmission probabilities, and dissipation can cause a soft induced gap~\cite{Takei2013,Liu2017,Stanescu2014}.
However, even without the aforementioned causes, a soft gap would still appear due to states with their momentum parallel to the junction~\cite{Gennes1963,Beenakker2005}.
