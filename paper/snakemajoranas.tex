...
\begin{align}
    ...
    &r = &\left(
    \begin{array}{rr}
    e^{i \nu_{\arg}}\left(\omega_+ - \omega_-\right) & (\omega _+ + \omega _-)\\
    -(\omega _+ + \omega _-) & - e^{-i \nu _{\arg }} \left(\omega _+ - \omega _-\right)\\
    \end{array}
    \right)
    \\
    &t = e^{-i q W} &\left(
    \begin{array}{rr}
    e^{i \nu_{\arg}}\left(\beta_+ - \beta_-\right) & (\beta_+ + \beta_-)\\
    -(\beta_+ + \beta_-) & - e^{-i \nu _{\arg }} \left(\beta_+ - \beta_-\right)\\
    \end{array}
    \right)
\end{align}

\begin{align}
    \omega_\pm = \frac{1}{4} \left(\gamma _{\pm}+\delta _{\pm}\right)
    \\
    \beta_\pm = \frac{1}{4} \left(\gamma _{\pm}-\delta _{\pm}\right)
\end{align}
\begin{align}
    \gamma_\pm = \frac{q+i k_{\pm} \tan \left(\frac{W k_{\pm}}{2}\right)}{q-i k_{\pm} \tan \left(\frac{W k_{\pm}}{2}\right)} \\
    \delta_\pm = \frac{q-i k_{\pm} \cot \left(\frac{W k_{\pm}}{2}\right)}{q+i k_{\pm} \cot \left(\frac{W k_{\pm}}{2}\right)}
\end{align}
