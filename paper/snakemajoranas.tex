...
We model the system with a BdG Hamiltonian Eq.~\eqref{eq:hamiltonian}; the normal part also has Rashba spin-orbit coupling and a Zeeman field, and the superconductors differ in superconducting phase.
...
\comment{We consider a 2D SNS junction with a Rashba-BdG Hamiltonian and zigzag geometry.}
