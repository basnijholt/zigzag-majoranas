...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\columnwidth]{figures/ns_junction.pdf}
\caption{Same as Fig.~\ref{fig:phasediagrams} but with one superconductor instead of two.
...
\caption{A comparison of a straight device (left panels) and a zigzag one (right panels) where the magnetic is rotated.
% E_gap(B, angle, \phi=\pi)
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.9\columnwidth]{figures/bandstructure_of_small_period_zigzag.pdf}
\caption{The effect of increased transparency.
% Like Fig 2. (b) plus horizontal dashed lines indicating the gap of zigzag and straight junctions
\label{fig:bandstructure_of_small_period_zigzag}}
\end{figure}
