...
In order to create a stable platform for quantum computing, Majorana bound states are one of the contenders currently being pursued.
Currently, most efforts to create pairs of Majorana's are based on hybrid NS structures, where a lengthy strip of semiconductor is interfaced with one, or two superconductor structures.
Assuming the right parameters, the semiconductor becomes topological and Majorana bound states appear at the ends of the segment.
In practice however, multiple problems arise making even the observation, let alone the manipulation of Majorana's difficult.
...
We claim that this is due to, from a semiclassical perspective, long paths through the semiconductor without interruption by the superconductor.
