...
A hybrid structure containing a semiconductor with strong spin-orbit coupling coupled to a superconductor, inside a magnetic field becomes topological within the right parameter regime ($E_\text{Z}^2>\mu^2+\Delta^2$ for a simple nanowire), and Majorana bound states appear on its edges~\cite{Lutchyn2010,Oreg2010}.
