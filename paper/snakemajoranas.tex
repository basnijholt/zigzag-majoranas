...
An important challenge in creating stable Majoranas is the appearance of a soft gap---a power law, instead of exponential decay of the density of states near zero energy.
It was shown previously that interface disorder and pairbreaking lead to a soft induced gap~\cite{takei_soft_2013}.
Even in systems with perfect interfaces and the absence of pairbreaking, states which have their momentum directed along the junction give rise to a soft gap~\cite{de_gennes_1963, beenakker_billiards_2005}.
