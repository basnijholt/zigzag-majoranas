...
Recently, two groups have realized this system experimentally.~\cite{fornieri_evidence_2018,ren_topological_2018}
In practice, multiple problems arise making even the observation difficult, leaving the manipulation of Majoranas problematic.
...
The parameters values are written on the bottom of Sec.~\eqref{sec:physical_picture}.\label{fig:bandstuctures}}
\end{figure}
...
The parameters values are written on the bottom of Sec.~\eqref{sec:physical_picture}.\label{fig:wavefunctions}}
\end{figure}
...
The parameters values are written on the bottom of Sec.~\eqref{sec:physical_picture}, except with $a=\SI{5}{\nm}$ and $L_\textrm{SC}=\SI{800}{\nm}$.
