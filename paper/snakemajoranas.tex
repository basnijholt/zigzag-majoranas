...
Additionally, these long trajectories have long flight times $\tau_f \approx L_\textrm{t} / v_F$ (see Fig.~\ref{fig:setup}), where $L_\textrm{t}$ is the trajectory length.
...
The yellow areas are the superconductors at an opposite superconducting phase $\pm \phi / 2$.
...
\begin{figure}[!htb]
\includegraphics[width=\columnwidth]{figures/wave functions}
...
The wave function extends to the center of the system, resulting in overlapping Majoranas and a non-zero energy of the state.
...
Quantitatively, the improvement in the localization of the Majoranas is also distinctly apparent: the energies of the Majorana states are three orders of magnitude lower than the energy of the second lowest-lying wave functions.
