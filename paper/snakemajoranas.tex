...
Additionally, these long trajectories have long flight times $\tau_f \approx W / v_F \sin\theta$ (see Fig.~\ref{fig:setup}(a)) and equivalenly small Thouless energies $E_{\textrm{Th}}=\hbar / \tau_f$, resulting in a small gap.
