...
Majorana bound states are a promising candidate to form the basis of a stable platform for topological quantum computing. ~\cite{alicea2012new,beenakker2013search,beenakker2016road,leijnse2012introduction}
...
The entire source code and the resulting raw data are available in Ref.~\onlinecite{data}.
...
Using the software package Qsymm~\cite{varjas2018qsymm}, we find that the zigzag shape modulation violates the chiral symmetry~\cite{1902.11300}, leaving only the particle-hole symmetry and the reflection symmetry with respect to the $x$-axis.
