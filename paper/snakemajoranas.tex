...
One of the biggest challenges in creating stable Majoranas is the appearance of a soft gap; which is the non-zero density of states near zero energy.
...
We propose a new experimental setup (see Fig.~\ref{fig:setup}(b)) for the creation of Majoranas that eliminates long trajectories and therefore prevents the appearance of a soft gap, while also increasing the topological gap by more than an order of magnitude, depending on the parameters.
