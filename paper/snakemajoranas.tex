...
Then, since $\alpha$ is only defined in the postitive imagionary plane, the energies are $\frac{E_{i}}{\Delta}=\textrm{Re}\left(\sqrt{-1/\lambda_{i}}\right)$ where we take the root which has a postitive imagionary part.
