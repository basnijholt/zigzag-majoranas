...
As mentioned in section \ref{sec:band_structures}, this can be attributed to the way the energy gap and velocity factor into the Majorana coherence length which scales with these parameters $\xi_\textrm{M}=\hbar v_\textrm{F} / \Delta_\textrm{ind}$.  % TODO: make this an Eq? And Replace Delta_ind by E_gap?
