...
One of the problems lying in the way of a stable system, is the appearance of a soft gap; the gap is greatly reduced for states with momentum directed along the length of the strip.
...
We show that introducing a zigzag or snake like geometry for the semiconductor removes these long trajectories and prevents the appearance of a soft gap.
