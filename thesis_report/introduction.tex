...
\section{Thesis structure}
	...
	Additionally, the reduction of the Majorana decay length allows for shorter systems to produce a higher magnitude of seperation, which is favorable because the coherence length of a material sets a limit for the device size.
