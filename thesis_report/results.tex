...
\chapter{Results \& Discussion}\label{chap:results}
	...
	\section{Finding the mechanism responsible for the increased gap}
		...
		We also perform the fully accurate calculation of the spectrum by simply computing the bandstructure of the corresponding Kwant system (labelled Full ribbon Kwant system): this result serves as the benchmark for the other techniques.
