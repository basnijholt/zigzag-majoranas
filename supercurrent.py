...
#####################################################################
    filled_in_calc_kpm_current_evs = partial(calc_kpm_current,
                                             syst_pars=syst_pars,
                                             params=params,
                                             cut_tag=cut_tag,
                                             direction=direction,
    ...
    ev_chunks = tuple(a[:,i:i+2] for i in range(a.shape[1]))
